...
function AdviceCard() {
    ...
    return (
        <div className='relative flex flex-col gap-5 items-center p-5 px-10'>
            ...
            <button aria-label="randomize" onClick={randomAdvice} className='transition-all ease-in-out flex justify-center mx-auto translate-y-10 bg-neon-green p-4 rounded-[30px] shadow-[0_0_15px_0_rgba(0,0,0,.5)] hover:shadow-neon-green'>
